...
public class SingleMovieScreen extends Screen {
    ...
    public SingleMovieScreen(views.Window parentWindow, Screen previousScreen, Movie movie){
        ...
        ImageIcon image = ImageHandler.scaleImage(new ImageIcon(movie.getImageData()), (int)(views.Window.width * 0.2));
    ...
    public JPanel buildSeatChart(Date choosenDate,String choosenShowing){
        ...
        int hallSize = new Hall(movie.getHallId()).getSeatsNumber();
